...
following sections. In \Cref{Sec:MathematicalModelFormulation}, we present our
mathematical model, which includes preventive vaccine dynamics.
\Cref{Sec:Rv_Analysis} includes an analysis of the vaccination reproductive
number. In \Cref{Sec:OptimalVaccinePolicies}, we define our optimal control
problem when modulating the vaccination rate by a time-dependent control signal
$u_V(t)$. \Cref{Sec:NumericalExperiment} presents our numerical results
