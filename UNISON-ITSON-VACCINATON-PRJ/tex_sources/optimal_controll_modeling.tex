...
solution of \Cref{model1,eqn:model1_counters} $S$, $V$, $X$ we modulate the
...
\unsure{Improve argument, how we can deduce the above equation}
...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
\Cref{tbl:ocp_parameters_description} enclose a parameters description
regarding with this controlled
version.

The classic results on Optimal control assure existence
of solution to our (OCP) in \Cref{eqn:optimal_control_problem}. Since our aim
