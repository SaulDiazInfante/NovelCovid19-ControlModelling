...
// Tdouble variables correspond to values that can change during 
// optimization:
// states, controls, algebraic variables and optimization parameters.
// Values that remain constant during optimization use standard types 
// (double, int, ...).
...
#include "header_criterion"
{
    ...
    double a_d = constants[9];
    
    Tdouble d_T = final_state[5];
    Tdouble x_zero_T = final_state[8];
    
    criterion = x_zero_T + a_d * d_T;
}
