...
#include "header_boundarycond"
{
    ...
    boundary_conditions[6] = final_state[5];
    boundary_conditions[7] = initial_state[6];
    boundary_conditions[8] = initial_state[7];
    boundary_conditions[9] = initial_state[8];
    boundary_conditions[10] = final_state[8];
    boundary_conditions[11] = initial_state[9];
}
