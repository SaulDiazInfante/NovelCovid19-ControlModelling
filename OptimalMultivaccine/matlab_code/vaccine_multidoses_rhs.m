...
% vaccine-multidoses right hand side function
    ...
    du_s = pars.mu  * n_aster + ...
        pars.delta_r * r_a + ...
        pars.delta_r_s * r_s + ...
        pars.delta_r_a * y_r_a - ...
            (lambda_f + pars.lambda_v_1_a + pars.mu) * s;
    du_e = lambda_f * s - ...
        (pars.delta_e + pars.lambda_v_1_a + pars.mu) * e;
    du_i_s = pars.p * (pars.delta_e * e + pars.delta_e_hat * x_e + ...
        pars.delta_e_tilde * y_e) - ...
    ...
    du_h = pars.delta_h * i_s - (pars.alpha_h + pars.mu_h + pars.mu) * h;
    du_r_s = pars.alpha_s * i_s + pars.alpha_h * h - ...
    ...
    du_y_r_a = pars.lambda_v_2_a * x_r_a + pars.alpha_a_tilde * y_i_a - ...
        (pars.delta_r_a + pars.mu) * y_r_a;
    %
    du_x_vac_1_a = pars.lambda_v_1_a * (s + e + i_a + r_a);
    du_x_vac_2_a = pars.lambda_v_2_a * (x_s + x_e + x_i_a + x_r_a);
    %
